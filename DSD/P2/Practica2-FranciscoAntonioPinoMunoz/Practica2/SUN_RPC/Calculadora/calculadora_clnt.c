...
double *
sumar_1(double operador_1, double operador_2,  CLIENT *clnt)
{
	sumar_1_argument arg;
	static double clnt_res;

	memset((char *)&clnt_res, 0, sizeof(clnt_res));
	arg.operador_1 = operador_1;
	arg.operador_2 = operador_2;
...
double *
restar_1(double operador_1, double operador_2,  CLIENT *clnt)
{
...
double *
multiplicar_1(double operador_1, double operador_2,  CLIENT *clnt)
{
...
double *
dividir_1(double operador_1, double operador_2,  CLIENT *clnt)
{
