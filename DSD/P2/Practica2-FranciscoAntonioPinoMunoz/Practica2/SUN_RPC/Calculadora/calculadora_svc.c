...
{
	return (sumar_1_svc(argp->operador_1, argp->operador_2, rqstp));
}

static double *
_restar_1 (restar_1_argument *argp, struct svc_req *rqstp)
{
	return (restar_1_svc(argp->operador_1, argp->operador_2, rqstp));
}

static double *
_multiplicar_1 (multiplicar_1_argument *argp, struct svc_req *rqstp)
{
	return (multiplicar_1_svc(argp->operador_1, argp->operador_2, rqstp));
}

static double *
_dividir_1 (dividir_1_argument *argp, struct svc_req *rqstp)
{
	return (dividir_1_svc(argp->operador_1, argp->operador_2, rqstp));
}
...
main (int argc, char **argv)
{
	...
	pmap_unset (DIRPROG, CALCULADORA);
	...
	if (!svc_register(transp, DIRPROG, CALCULADORA, dirprog_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (DIRPROG, CALCULADORA, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, DIRPROG, CALCULADORA, dirprog_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (DIRPROG, CALCULADORA, tcp).");
		exit(1);
	}
